				...
				<div id="sds-theme-options-ads" class="sidebar">
					<div class="sds-theme-options-ad">
						...
						<div class="slocum-themes">
							<?php printf( __( '<a href="%1$s" target="_blank"><strong>How to setup the perfect WordPress website</strong></a>', 'journal' ), 'http://slocumthemes.com/build-perfect-wordpress-website/' ); ?>
						</div>
